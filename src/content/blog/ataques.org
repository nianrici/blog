#+title: Ataques
#+date: 2026-03-15
#+description: Artículo sobre Ataques
** Ataques DoS
:PROPERTIES:
:CUSTOM_ID: ataques-dos
:END:
Ataques diseñados para denegar el servicio por parte de un servidor.

*** Teardrop Attack
:PROPERTIES:
:CUSTOM_ID: teardrop-attack
:END:
...
:PROPERTIES:
:CUSTOM_ID: ping-de-la-muerte-ping-of-death
:END:
...
:PROPERTIES:
:CUSTOM_ID: ataque-pitufo-smurf-attack
:END:
...
:PROPERTIES:
:CUSTOM_ID: ataque-fraggle-si-fraggle-attack
:END:
...
:END:
- [[http://www.dankalia.com/tutor/01001/0100101077.htm]]
